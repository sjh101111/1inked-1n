...
export const readUserAllArticles = async (email) => {
    const readUserAllArticlesURL = `${URL}/api/userAllArticles/${email}`;

    return OneinkedGet(readUserAllArticlesURL)
        .then((response) => response.data)
};
...
export const getResumeByEmail = async (email) => {
    const getResumeByEmailURL = `${URL}/api/resume/user/${email}`

    return OneinkedGet(getResumeByEmailURL)
        .then((response) => response.data)
};
/** Resume API END */
...
export const getFollowsOfUser = async (email) => {
    const getFollowsOfUserURL = `${URL}/api/followsOfUser/${email}`;

    return OneinkedGet(getFollowsOfUserURL)
        .then((response) => response.data)
};
...
export const getFollowersOfUser = async (email) => {
    const getFollowersOfUserURL = `${URL}/api/followersOfUser/${email}`;

    return OneinkedGet(getFollowersOfUserURL)
        .then((response) => response.data)
};
/** Follow API END */